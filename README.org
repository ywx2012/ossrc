...
apk add make cpio git python3 py3-pip
#+END_SRC
...
apt-get install make cpio git python3 pip
#+END_SRC
...
pacman -S make cpio git python python-pip
#+END_SRC
...
dnf install --setopt=install_weak_deps=False make cpio git python3 python3-pip
#+END_SRC
...
apt-get --no-install-recommends install make cpio git python3 ca-certificates python3-pip
#+END_SRC
...
zypper install --no-recommends make cpio git python3 python3-pip
#+END_SRC
...
apt-get --no-install-recommends install make git cpio python3 ca-certificates python3-pip
#+END_SRC
...
xbps-install -S make cpio git python3 python3-pip
#+END_SRC
